...
#ifdef DT_WNC_M14A2A_0_MDM_SEND_OK_GPIOS_GPIO_PIN
	MDM_SEND_OK,
#endif
...
static const struct mdm_control_pinconfig pinconfig[] = {
	/* MDM_BOOT_MODE_SEL */
	PINCONFIG(DT_WNC_M14A2A_0_MDM_BOOT_MODE_SEL_GPIOS_GPIO_CONTROLLER,
		  DT_WNC_M14A2A_0_MDM_BOOT_MODE_SEL_GPIOS_GPIO_PIN),

	/* MDM_POWER */
	PINCONFIG(DT_WNC_M14A2A_0_MDM_POWER_GPIOS_GPIO_CONTROLLER,
		  DT_WNC_M14A2A_0_MDM_POWER_GPIOS_GPIO_PIN),

	/* MDM_KEEP_AWAKE */
	PINCONFIG(DT_WNC_M14A2A_0_MDM_KEEP_AWAKE_GPIOS_GPIO_CONTROLLER,
		  DT_WNC_M14A2A_0_MDM_KEEP_AWAKE_GPIOS_GPIO_PIN),

	/* MDM_RESET */
	PINCONFIG(DT_WNC_M14A2A_0_MDM_RESET_GPIOS_GPIO_CONTROLLER,
		  DT_WNC_M14A2A_0_MDM_RESET_GPIOS_GPIO_PIN),

	/* SHLD_3V3_1V8_SIG_TRANS_ENA */
	PINCONFIG(DT_WNC_M14A2A_0_MDM_SHLD_TRANS_ENA_GPIOS_GPIO_CONTROLLER,
		  DT_WNC_M14A2A_0_MDM_SHLD_TRANS_ENA_GPIOS_GPIO_PIN),

#ifdef DT_WNC_M14A2A_0_MDM_SEND_OK_GPIOS_GPIO_PIN
	/* MDM_SEND_OK */
	PINCONFIG(DT_WNC_M14A2A_0_MDM_SEND_OK_GPIOS_GPIO_CONTROLLER,
		  DT_WNC_M14A2A_0_MDM_SEND_OK_GPIOS_GPIO_PIN),
#endif
};
