...
elseif("${ZEPHYR_TOOLCHAIN_VARIANT}" STREQUAL "xcc")
  ...
  set(TOOLCHAIN_INCLUDES
      ${TOOLCHAIN_HOME}/lib/xcc/include
      ${TOOLCHAIN_HOME}/xtensa-elf/include
      ${XCC_BUILD}/xtensa-elf/arch/include
      ${XCC_BUILD}/xtensa-elf/include
      )

  LIST(APPEND TOOLCHAIN_LIBS gcc)
  LIST(APPEND TOOLCHAIN_LIBS hal)

  LIST(APPEND LIB_INCLUDE_DIR -L${SYSROOT_DIR})
  LIST(APPEND LIB_INCLUDE_DIR -L${XCC_BUILD}/xtensa-elf/lib/xcc)
  LIST(APPEND LIB_INCLUDE_DIR -L${XCC_BUILD}/xtensa-elf/lib)
  LIST(APPEND LIB_INCLUDE_DIR -L${XCC_BUILD}/xtensa-elf/arch/lib)
endif()
