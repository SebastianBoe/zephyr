...
class Options(CogOptions):
    ...
    generator_start_marker = b'@code{.codegen}'
    generator_end_marker = b'@endcode{.codegen}'
    end_marker = b'@code{.codeins}@endcode'
    ...
    def parse_args(self, argv):
        ...
        # set options
        self.sBeginSpec = self.generator_start_marker.decode('utf-8')
        self.sEndSpec = self.generator_end_marker.decode('utf-8')
        self.sEndOutput = self.end_marker.decode('utf-8')
