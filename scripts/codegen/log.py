    ...
    def log(self, message, message_type=None, end="\n", logonly=True):
        ...
        if not logonly:
            if message_type == 'error: ':
                print(message_type+message, file=self.stderr, end=end)
            else:
                print(message_type+message, file=self.stdout, end=end)

    def msg(self, s):
        self.log(s, message_type='message', logonly=False)

    def error(self, msg='Error raised by codegen.'):
        """ The codegen.error function.
            ...
            traceback.
        """
        self.log(msg, message_type='error')
